import{_ as a,c as n,o as s,a4 as p}from"./chunks/framework.mYiZUlLS.js";const m=JSON.parse('{"title":"🛖 数据库表文档","description":"","frontmatter":{},"headers":[],"relativePath":"document/workers/timehut/数据库表.md","filePath":"document/workers/timehut/数据库表.md"}'),e={name:"document/workers/timehut/数据库表.md"},l=p(`<h1 id="🛖-数据库表文档" tabindex="-1">🛖 数据库表文档 <a class="header-anchor" href="#🛖-数据库表文档" aria-label="Permalink to &quot;🛖 数据库表文档&quot;">​</a></h1><h2 id="familyrelation-家人关系" tabindex="-1">FamilyRelation 家人关系 <a class="header-anchor" href="#familyrelation-家人关系" aria-label="Permalink to &quot;FamilyRelation 家人关系&quot;">​</a></h2><p>正向关系和反向关系 with_user_id 是 user_id 的 relation (妈妈)</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>{</span></span>
